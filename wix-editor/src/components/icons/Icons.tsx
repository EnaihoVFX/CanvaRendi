...
export const SectionIcon = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <line x1="2" y1="10" x2="22" y2="10" strokeOpacity="0.3" />
    </svg>
);
...
export const AccordionIcon = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <polyline points="17 6 19 7 17 8" />
    </svg>
);
...
// Export icon lookup maps
export const ElementIcons: Record<string, React.FC> = {
    text: TextIcon,
    heading: HeadingIcon,
    paragraph: TextIcon,
    image: ImageIcon,
    ...
    footer: FooterIcon,
    form: FormIcon,
    'contact-form': FormIcon,
    'subscribe-form': FormIcon,
    input: InputIcon,
...
export const GenericIcons: Record<string, React.FC> = {
